...
| 2 | **Notes-file import** | Parse the existing notes file to backfill history; makes the dashboard valuable from day one. Parser design depends on the file format — get a sample early. | H | M |
...
| 2 | Notes-file import | Instantly makes dashboards meaningful; the data already exists | No |
